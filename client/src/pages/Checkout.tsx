              ...
              <CardHeader>
                <CardTitle className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Licença Premium FovDark</p>
                  </div>
                </CardTitle>
              </CardHeader>
    ...
    <div className="py-20 min-h-screen">
      ...
      <div className="container mx-auto px-6 max-w-6xl">
                ...
                <Button
                  className={`w-full font-bold text-lg py-3 ${
                    plan.popular
                      ...
                      : "bg-card/50 border border-primary/50 hover:bg-primary/10"
                  }`}
        ...
        <div className="text-center mt-12">
          <div className="bg-card/30 backdrop-blur-sm rounded-lg p-6 max-w-2xl mx-auto">
            <h3 className="text-xl font-bold mb-4">
              🔒 Garantia de Segurança
            </h3>
            <p className="text-gray-300 mb-4">
              Todos os nossos cheats são desenvolvidos com tecnologia anti-detecção avançada.
              Oferecemos suporte 24/7 e atualizações constantes.
            </p>
