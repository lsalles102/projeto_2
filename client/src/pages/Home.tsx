        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
          <div className="animate-slideIn">
            <h1 className="text-5xl md:text-7xl font-orbitron font-black mb-6 text-glow">
              CHEATS <span className="text-neon-green">BLOODSTRIKE</span>{" "}
              PREMIUM
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                variant="ghost"
                className="px-8 py-4 glass-effect rounded-lg font-bold text-lg hover:bg-glass-border transition-all duration-300"
              >
