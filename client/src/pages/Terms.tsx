        ...
        <Card className="glass-effect border-glass-border">
          ...
          <CardContent className="prose prose-invert max-w-none">
            <div className="space-y-6 text-gray-300">
              <section>
                <h2 className="text-xl font-bold text-neon-green mb-3">1. Aceitação dos Termos</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-bold text-neon-green mb-3">2. Uso do Software</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-bold text-neon-green mb-3">3. Licenças</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-bold text-neon-green mb-3">4. Restrições</h2>
              ...
              <section>
                <h2 className="text-xl font-bold text-neon-green mb-3">5. Privacidade</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-bold text-neon-green mb-3">6. Isenção de Responsabilidade</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-bold text-neon-green mb-3">7. Modificações</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-bold text-neon-green mb-3">8. Contato</h2>
                <p>
